...
void printLoudest(void)
{
  ...
  uint32_t A_freq[] = {55, 110, 220, 440, 880, 1760, 3520, 7040}; // all octaves
  uint32_t err_freq = 10;
  ...
  for (int i = 0; i < 8; i++){
    if ( (ui32LoudestFrequency < (A_freq[i] + err_freq)) && (ui32LoudestFrequency > (A_freq[i] - err_freq)) ) {
